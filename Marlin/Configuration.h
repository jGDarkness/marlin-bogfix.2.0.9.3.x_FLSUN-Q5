...
#define STRING_CONFIG_H_AUTHOR "(jgDarkness)" // Who made the changes.
 ...
 *
 */
#define TEMP_SENSOR_0 11 //Using an aftermarket NTSC3950 which works best on 11
...
#define TEMP_SENSOR_BED 1 //Using original heatbed thermistor which works best on 1
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.3349
    #define DEFAULT_Ki   2.2900
    #define DEFAULT_Kd  49.6916
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 136.2683
  #define DEFAULT_bedKi 26.8430
  #define DEFAULT_bedKd 461.1773
...
//#define USE_ZMIN_PLUG // Should default to PC13 based on board pin out code.
...
/* BTT SKR3 uses PIN PC13, and FLSUN Leveling switch is grounded to the ground 
on the Servo port.JST connectors are modified to fit.
*/
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.45 }
...
//#define PROBE_ACTIVATION_SWITCH
  ...
  #define PROBE_ACTIVATION_SWITCH_PIN PC13 // Override default pin
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 2 }
